	...
	public class GameTest {
		...
		public static void main(String[] args) {
			...
			Questions [] question = { 
					...
					new Questions (q3, "b", null), 
					new Questions (q4, "b", null),
					new Questions (q5, "c", null),
					new Questions (q6, "b", null),
					new Questions (q7, "c", null),
		...
		public static void countScore(int score) {	
			if (score <=3) {
				...
				System.out.println("You’re pretty solid in your Java history, but it might behoove you to pay a little more attention to the details.");
